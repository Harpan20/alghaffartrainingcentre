            ...
            <div class="flex">
                ...
                <div class="flex shrink-0 items-center">
                    <a href="{{ route('dashboard') }}">
                        <img class="block h-9 w-auto fill-current text-gray-800 dark:text-gray-200" src="{{ Vite::asset('resources/images/logo-icon.png') }}" alt="Al-Ghaffar">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('admin.galeri.foto.index')" :active="request()->routeIs('admin.galeri.foto.index')">
                        {{ __('Galeri Foto') }}
                    </x-nav-link>
                </div>
                ...
                <!-- <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link
                        ...
                        :active="request()->routeIs('admin.galeri.video.index')"
                    >
                        {{ __('Galeri Video') }}
                    </x-nav-link>
                </div> -->
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('admin.profil.index')" :active="request()->routeIs('admin.profil.index')">
                        {{ __('Profil') }}
                    </x-nav-link>
                </div>
